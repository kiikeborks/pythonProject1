...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        # 2. Kliknij "Don't allow", aby nie zezwolić na dostęp do lokalizacji
        # 3. Kliknij "Next"
    ...
    def testID001_registerNewUserWithWrongEmailTest(self):
        ...
        close_btn.click()
        # 2. Don't allow for access to localisation
        ...
        # Assert Final Result
        error_notice = self.driver.find_element(AppiumBy.XPATH, "//android.view.View[@content-desc='Oops, something went wrong. Please, try again.']")
